...
public class TestPractitionerHavingOnlyOneGlobalPatientsVerifyThePopupAppear {
	WebDriver driver;
	...
	public void login() throws InterruptedException, IOException {
		...
		basepage.elementWait(3000);
		pracLogin.prEmail().sendKeys(genericMethods.dataprp("qaOnePrctitionerDiscount"));
	...
	// Practitioner is having patients in the list with Global Discount only.
