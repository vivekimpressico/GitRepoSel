...
public class TestPatientPlaceOrderNexusPractitioner extends Data_Provider {
	WebDriver driver;
	...
	public void loginPatients() throws InterruptedException, IOException {
		...
		pracLogin.pracLoginButton().click();
		basepage.implicitywait(1000);
		pracLogin.prEmail().sendKeys(genericMethods.dataprp("salesTaxNonTaxblePatientNexusPrac"));
		// pracLogin.prEmail().sendKeys(genericMethods.dataprp("salesTaxNonNexusPatientsNexusPrac"));
		// pracLogin.prEmail().sendKeys(genericMethods.dataprp("salesTaxNexusPatientNexusPrac"));
		pracLogin.prPassword().sendKeys(genericMethods.dataprp("password"));
		basepage.implicitywait(1000);
		pracLogin.prLogin().click();
		basepage.elementWait(5000);
