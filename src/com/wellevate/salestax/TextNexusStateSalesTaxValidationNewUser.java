...
public class TextNexusStateSalesTaxValidationNewUser extends Data_Provider {
	WebDriver driver;
	...
	public void loginPractitioner() throws InterruptedException, IOException {
		...
		pracLogin.prEmail().sendKeys(genericMethods.dataprp("NexusStateSalesTaxValidationNewUser"));
	...
	@Test(priority = 2)
	public void practitionerSalesTaxTab() throws InterruptedException, IOException {
		basepage.elementWait(5000);
	...
	public void practitionerResaleCertificationError() throws InterruptedException, IOException, BiffException {
		...
		praSalesTax.salesTaxOpt(genericMethods.ConfigFile("salestax"));
		basepage.elementWait(3000);
		ActReSaleCertificationError = praSalesTax.salesTaxResaleCertificationError().getText().trim();
		basepage.elementWait(3000);
		ExpReSaleCertificationError = genericMethods.ConfigFile("VALID_RESALE_CERTIFICATE_SALESTAX").trim();
	...
	public void practitionerUploadCertificationError() throws InterruptedException, IOException, BiffException {
		...
		praSalesTax.salesTaxOpt(genericMethods.ConfigFile("salestax"));
		basepage.elementWait(3000);
		praSalesTax.salesTaxResaleCertificationField(0,"12345");
		basepage.elementWait(3000);
		ActUploadFileError = praSalesTax.salesTaxFileUploadError().getText().trim();
		basepage.elementWait(3000);
		ExpUploadFileError = genericMethods.ConfigFile("UPLOAD_VALID_FILE_SALESTAX").trim();
