...
public class BasePage extends ProjectSetup {
	...
	public static WebElement getElementfluent(final By by) {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(6000, TimeUnit.SECONDS)
	...
	// Wait
	public static WebElement getElementfluent1(final By by) {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(5000, TimeUnit.SECONDS)
...
// }
// double[] doubleList = new double[actPrice.size()];
// double sum = 0;
// for (int i = 0; i < actPrice.size(); ++i) {
// doubleList[i] = Double.parseDouble(actPrice.get(i));
// sum += doubleList[i];
