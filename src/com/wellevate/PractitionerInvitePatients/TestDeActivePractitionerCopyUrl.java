...
public class TestDeActivePractitionerCopyUrl {
	WebDriver driver;
	...
	// De-Active Patients adds their Address details
	@SuppressWarnings("static-access")
	@Test(priority = 1)
	public void patientsAddress() throws InterruptedException, IOException {
		basepage.elementWait(5000);
		driver.get("http://well-qa.wsnycdev.com/arun-sahoo-30006/#/patient/registration/1/1f4799ef654eb51d52a02e667753864fe09b38492000348e97d8a8cbf27c5e18d11dae85fd27fa68a446925b4acee980002a");
		...
		SoftAssertions.verifyEquals(signupPrac.createAccount().isDisplayed(), true,
				" Create Account Button is Greyed out", "Create Account Button is Clikable");
