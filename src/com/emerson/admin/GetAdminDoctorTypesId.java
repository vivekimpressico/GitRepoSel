...
public class GetAdminDoctorTypesId extends APIBaseData{
	...
	String actdoctorTypeKey = "1";

	@Test(priority = 1)
	public void AccountCredentialWithoutToken() throws Exception {
		try {
			URL url1 = new URL("http://qa-aresapi.emersonecologics.com/admin/doctortypes/"+actdoctorTypeKey);
	...
	public void AccountCredentialWithAccount() throws InterruptedException, ClientProtocolException, IOException {
		...
		HttpGet request = new HttpGet("http://qa-aresapi.emersonecologics.com/admin/doctortypes/"+actdoctorTypeKey);
		...
		String doctorTypeKey = response.get("response_doctorTypeKey");
		SoftAssertions.verifyEqualsApi(doctorTypeKey, actdoctorTypeKey, " doctorTypeKey matches", "doctorTypeKey not matches");
		SoftAssertions.throwAsserationOnFailure();
	}
}
