...
public class GetAdminSalesPerson extends APIBaseData{
	...
	public void AccountCredentialWithoutToken() throws Exception {
		try {
			URL url1 = new URL("http://qa-aresapi.emersonecologics.com/admin/salespersons");
	...
	public void AccountCredentialWithAccount() throws InterruptedException, ClientProtocolException, IOException {
		...
		HttpGet request = new HttpGet("http://qa-aresapi.emersonecologics.com/admin/salespersons");
		...
		SoftAssertions.verifyEqualsApi(totalResults, "593000", " totalResults matches", "totalResults not matches");
