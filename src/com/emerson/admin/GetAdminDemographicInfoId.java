...
public class GetAdminDemographicInfoId extends APIBaseData {
	...
	String demographicInfoId = "4";

	@Test(priority = 1)
	public void AccountCredentialWithoutToken() throws Exception {
		try {
			URL url1 = new URL("http://qa-aresapi.emersonecologics.com/admin/demographicInfo/"+demographicInfoId);
	...
	public void AccountCredentialWithAccount() throws InterruptedException, ClientProtocolException, IOException {
		...
		HttpGet request = new HttpGet("http://qa-aresapi.emersonecologics.com/admin/demographicInfo/"+demographicInfoId);
		...
		String questionText = response.get("response_questionText");
		SoftAssertions.verifyEqualsApi(questionText, "How did you hear about us?", " questionText matches", "questionText not matches");
		SoftAssertions.throwAsserationOnFailure();
	}
}
