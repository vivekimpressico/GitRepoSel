...
public class GetBrandAgreements extends APIBaseData {
	...
	public void AccountCredentialWithAccount() throws InterruptedException, ClientProtocolException, IOException {
		...
		String brandAgreementId = response.get("response_currentPage_0_brandAgreementId");
		SoftAssertions.verifyEqualsApi(totalResults, "17", " totalResults matches", "totalResults not matches");
		SoftAssertions.verifyEqualsApi(pageSize, "5000", " pageSize matches", "pageSize not matches");
		SoftAssertions.verifyEqualsApi(brandAgreementId, actbrandAgreementId, "brandAgreementId at 0  matches", "brandAgreementId at 0 not matches");
		SoftAssertions.throwAsserationOnFailure();
	}
}
