...
public class GetBrandagreementsEnvelopeldDownload extends APIBaseData {
	...
	String Envelopeld = "8652";

	@Test(priority = 1)
	public void AccountwishlistsIdWithoutToken() throws Exception {
		try {
			URL url1 = new URL("http://qa-aresapi.emersonecologics.com/account/brandagreements/"+Envelopeld+"/download");
	...
	public void AccountwishlistsIdWithAccount() throws InterruptedException, ClientProtocolException, IOException {
		...
		HttpGet request = new HttpGet("http://qa-aresapi.emersonecologics.com/account/brandagreements/"+"Envelopeld"+"/download");
		...
		String wishListId = response.get("response_wishListId");
