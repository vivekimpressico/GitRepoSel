...
public class PostAccountCredential {
	...
	public void postAccount() {
		try {
			...
			HttpPost request = new HttpPost("http://qa-aresapi.emersonecologics.com/account/credentials");
...
//			SoftAssertions.verifyEqualsApi(brandCode,brandcode,"brandcode matches", "brandcode not matches");
