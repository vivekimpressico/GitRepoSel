...
public class DeleteSubscrptionType {
	...
	String subscrptionType = "Brand Products & Information";
	...
	public void postAccount() {
		try {
			...
			HttpDelete delete = new HttpDelete(
					"http://qa-aresapi.emersonecologics.com/account/emailpreferences"+subscrptionType);
