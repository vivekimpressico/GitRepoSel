...
public class PostEmailSubscrptionType {
	...
	String SubscrptionType = "Emerson Ecologics Updates";

	@Test(priority = 1)
	public void postAccount() {
		try {
	//		String obj = "{\"credentialType\":2,\"licenseNumber\":\""+actlicenseNumber+"\",\"expirationDate\":\"200019-01-31 00:00:00.000\",\"stateIssued\":\"MI\",\"doctorTypeId\":\"MD\",\"doctorTypeKey\":1,\"fileName\":\"00LITTL.JPG\",\"fileType\":\"image/jpeg\",\"fileBytes\":\"  \"}";
			String auth_token = APIBaseData.getUserAuthToken();
			HttpPost request = new HttpPost("http://qa-aresapi.emersonecologics.com/account/emailpreferences/"+"Emerson"+"%2000"+"Ecologics"+"%2000"+"Updates");
	...
	//		request.setEntity(new StringEntity(obj));
			...
			SoftAssertions.verifyEqualsApi(response, "Subscription type: Emerson Ecologics Updates updated successfully", "Subscription type matches",
					"Subscription type matches not matches");
