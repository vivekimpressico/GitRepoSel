...
public class GetAccountCredential extends APIBaseData {
	...
	public void AccountCredentialWithoutToken() throws Exception {
		try {
			URL url1 = new URL("http://qa-aresapi.emersonecologics.com/account/credentials");
	...
	public void AccountCredentialWithAccount() throws InterruptedException, ClientProtocolException, IOException {
		...
		HttpGet request = new HttpGet("http://qa-aresapi.emersonecologics.com/account/credentials");
...
//		String credentialId = response.get("response_currentPage_0_credentialId");
//		SoftAssertions.verifyEqualsApi(credentialId, "19100047", " credentialId matches", "credentialId not matches");
