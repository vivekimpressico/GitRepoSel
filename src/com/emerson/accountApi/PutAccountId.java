...
public class PutAccountId {
	...
	String credentialId = "1222";
	String actcustomerId = "00355147";

	@SuppressWarnings("unused")
	@Test(priority = 1)
	public void putAccountAdd() {
		try {
			creatingRandomEmailAddress.emailApi();
			String email = genericMethods.ApiCredential("emailapi");
			String obj = "{\"businessName\":\""+email+"\",\"email\":\"test@test.com\",\"password\":\"demo@123\",\"phoneNumber\":\"1234567890\",\"phoneNumberExt\":\"\",\"firstName\":\"Test\",\"middleInitial\":\"\",\"lastName\":\"User\",\"title\":\"Dr.\",\"suffix\":\"\",\"professionalDesignation\":\"MD, ND\"}";
			String auth_token = APIBaseData.getUserAuthToken();
			HttpPut request = new HttpPut("http://qa-aresapi.emersonecologics.com/account/" + actcustomerId);
			...
			String businessName = APIBaseData.dataObject.get("response_businessName");
		   SoftAssertions.verifyEqualsApi(customerId,actcustomerId,"customerId matches", "customerId not matches");
		   SoftAssertions.verifyEqualsApi(businessName,businessName,"businessName matches", "businessName not matches");
