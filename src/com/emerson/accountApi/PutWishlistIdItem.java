...
public class PutWishlistIdItem {
	...
	public void postAccount() {
		try {
			...
			String itemId = APIBaseData.dataObject.get("response_itemId");
			String quantity = APIBaseData.dataObject.get("response_quantity");
			...
			SoftAssertions.verifyEqualsApi(quantity, 0, "quantity matches", "quantity not matches");
		} catch (Exception e) {
			e.printStackTrace();
