...
public class PostCreateAddressShipping {
	...
	public void postAccount() {
		try {
			...
			String obj = "{\"recipientName\":\""+email+"\",\"line1\":\"13148 Chatham Dr\",\"line2\":\"\",\"city\":\"Rancho\",\"regionCode\":\"CA\",\"regionName\":\"California\",\"postalCode\":\"91739\",\"countryCode\":\"US\",\"countryName\":\"United States\",\"phoneNumber\": \"4025166440\",\"phoneNumberExt\": null,\"isDropShip\":\"false\",\"addressType\":\"1\",\"isDefault\":\"false\"}";
			String auth_token = APIBaseData.getUserAuthToken();
			HttpPost request = new HttpPost("http://qa-aresapi.emersonecologics.com/account/address");
