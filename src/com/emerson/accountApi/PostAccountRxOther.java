...
public class PostAccountRxOther {
	...
	String actlicenseNumber = "43000100026471";
	...
	public void postAccount() {
		try {
			...
			HttpPost request = new HttpPost("http://qa-aresapi.emersonecologics.com/account/rx");
			...
			String licenseNo = APIBaseData.dataObject.get("response_licenseNo");
			SoftAssertions.verifyEqualsApi(licenseNo, actlicenseNumber, "licenseNo matches", "licenseNo not matches");
