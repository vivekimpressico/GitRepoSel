...
public class GetAccountwishlistsIdApi extends APIBaseData{
	...
	public void AccountwishlistsIdWithoutToken() throws Exception {
		try {
			URL url1 = new URL("http://qa-aresapi.emersonecologics.com/account/wishlists/"+wishlistsId);
	...
	public void AccountwishlistsIdWithAccount() throws InterruptedException, ClientProtocolException, IOException {
		...
		HttpGet request = new HttpGet("http://qa-aresapi.emersonecologics.com/account/wishlists/"+wishlistsId);
