...
public class PutAccountPaymentDefaultId {
	...
	public void postAccount() {
		try {
			...
			HttpPut request = new HttpPut(
					"https://qa-aresapi.emersonecologics.com/account/payments/default/" + "%7B" + actId + "%7D");
			...
			SoftAssertions.verifyEqualsApi(response, "true", "creditCardId matches", "creditCardId is not matches");
