...
public class PostWishlist {
	...
	public void postAccount() {
		try {
			String obj = "{\"listName\": \"NewName12\",\"wishListItems\":[{\"itemId\":\""+itemId+"\",\"quantity\":2,\"note\":\"Insert\"}]}";
			String auth_token = APIBaseData.getUserAuthToken();
			HttpPost request = new HttpPost("http://qa-aresapi.emersonecologics.com/account/wishlists");
			...
			String itemId = APIBaseData.dataObject.get("response_currentPage_0_wishListItems_0_itemId");
