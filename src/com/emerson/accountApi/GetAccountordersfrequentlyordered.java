...
public class GetAccountordersfrequentlyordered extends APIBaseData {
	...
	@Test(priority = 1)
	public void ccountordersfrequentlyorderedWithOutt() throws Exception {
		try {
			URL url1 = new URL("http://qa-aresapi.emersonecologics.com/account/orders/frequentlyordered");
	...
	public void CodeForAccountWrightEmailId() throws InterruptedException, ClientProtocolException, IOException {
		...
		HttpGet request = new HttpGet("http://qa-aresapi.emersonecologics.com/account/orders/frequentlyordered");
...
//		String quantityOrdered = response.get("response_0_quantityOrdered");
//
//		SoftAssertions.verifyEqualsApi(itemId, "BABYS", " itemId matches", "itemId not matches");
//		SoftAssertions.verifyEqualsApi(itemName, "Baby Starter Kit 1 bag", "itemName matches",
//				"itemName is not matches");
//		SoftAssertions.verifyEqualsApi(quantityOrdered, "1", "quantityOrdered matches",
//				"quantityOrdered is not matches");
		SoftAssertions.throwAsserationOnFailure();
	}
}
