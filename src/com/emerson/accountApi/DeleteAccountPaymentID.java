...
public class DeleteAccountPaymentID {
	...
	String creditcardID = "b3df3c00-70009f-4388-adea-a6ba18beebc6";
	...
	public void postAccount() {
		try {
			...
			HttpDelete delete = new HttpDelete(
					"http://qa-aresapi.emersonecologics.com/account/payments/" + "%7B" + creditcardID + "%7D");
			...
			SoftAssertions.verifyEqualsApi(response, "Credit card deleted successfully",
					"Credit card deleted successfullY", "Credit card not deleted successfully");
